...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { height: @measurement.height, mass: @measurement.mass, user_id: @measurement.user_id }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { height: @measurement.height, mass: @measurement.mass, user_id: @measurement.user_id }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
